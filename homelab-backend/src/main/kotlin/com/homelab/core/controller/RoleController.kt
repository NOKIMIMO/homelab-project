...
// This does not grant the ability to change a user's isAdmin flag - that stays admin-only
// (AdminController.setAdmin), matching "changer les rôles, sauf de l'administrateur".

  ...
  return (
    <form onSubmit={passwordFlow === 'signup' ? handleRegister : handlePasswordLogin} className="space-y-6">
      ...
      <div className="rounded-2xl border border-base-content/10 bg-base-200/70 p-2">
        ...
        <button
          type="button"
          className={`btn btn-sm ${passwordFlow === 'login' ? 'btn-primary shadow-lg shadow-primary/20' : 'btn-ghost'}`}
          onClick={() => {
        ...
        <button
          type="button"
          className={`btn btn-sm ${passwordFlow === 'signup' ? 'btn-primary shadow-lg shadow-primary/20' : 'btn-ghost'}`}
          onClick={() => {
      ...
      <div className="grid grid-cols-1 gap-4">
        <div className="form-control w-full gap-1">
          ...
          <input
            type="email"
            className="input input-bordered h-12 w-full rounded-xl border-base-content/10 bg-base-200 focus:input-primary"
      ...
      <button className="btn btn-primary w-full gap-2 shadow-lg shadow-primary/20 h-14 rounded-2xl text-base" disabled={loading}>

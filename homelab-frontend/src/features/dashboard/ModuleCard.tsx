...
import { ShieldCheck, ShieldAlert, Square, Play } from "lucide-react";
                    ...
                    <div className="flex items-center justify-between mt-2">
                      ...
                      <div className="flex gap-2">
                        {modules.status === 'ACTIVE' ? (
                          ...
                          >
                            {actionLoading === modules.id ? <span className="loading loading-spinner loading-xs"></span> : <Square size={16} />}
                          </button>
                        ) : (
                          <>
                            <button 
                              ...
                              disabled={actionLoading === modules.id}
                            >
                              {actionLoading === modules.id ? <span className="loading loading-spinner loading-xs"></span> : <Play size={16} />}
                              Lancer
                            </button>
                          </>
                        )}
